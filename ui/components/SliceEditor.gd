...
func _ready() -> void:
	...
	# focus, which makes the engine hide the caret. Keep it solid (no blink)
	# and thicken it so mobile users can see where they are typing. NOTE: this
	# engine build has no TextEdit.caret_force_displayed property.
